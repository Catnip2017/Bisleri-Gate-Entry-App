          ...
          <View style={styles.sidebar}>
            ...
            {user && (
              <>
               ...
               {user.warehouseCode && <Text style={styles.sidebarItem}>WH Code: {user.warehouseCode}</Text>}
               {user.siteCode && <Text style={styles.sidebarItem}>Site Code: {user.siteCode}</Text>}
