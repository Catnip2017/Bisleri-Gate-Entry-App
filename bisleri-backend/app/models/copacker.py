...
class CopackerCapture(Base):
    ...
    last_hour_production_count     = Column(BigInteger, nullable=True)
    production_count_current_batch = Column(BigInteger, nullable=True)
    total_production_count         = Column(BigInteger, nullable=True)
    good_bottles_count             = Column(BigInteger, nullable=True)
    preforms_processed_count       = Column(BigInteger, nullable=True)
    target_batch_quantity          = Column(BigInteger, nullable=True)
